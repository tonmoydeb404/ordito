...
export class ApiService {
  ...
  static async createCommandGroup(request: CreateGroupRequest): Promise<CommandGroup> {
    return invoke('create_command_group', { request });
  }

  static async updateCommandGroup(request: UpdateGroupRequest): Promise<CommandGroup> {
  ...
  static async executeCommandGroup(id: string, detached?: boolean): Promise<string[]> {
  ...
  static async updateSchedule(request: UpdateScheduleRequest): Promise<Schedule> {
  ...
  static async getNextScheduledExecutions(limit?: number): Promise<Array<{ id: string; next_execution: string }>> {
    return invoke('get_next_scheduled_executions', { limit });
  }

  // Execution operations
  static async getExecutionStatus(executionId: string): Promise<CommandExecution | null> {
  ...
  static async getExecutionHistory(limit?: number): Promise<CommandExecution[]> {
